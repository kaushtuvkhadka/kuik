...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_KUik_GUI_Sxm)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_KUik_GUI_Sxm))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_KUik_GUI_Sxm)() {
    return 1;
}
