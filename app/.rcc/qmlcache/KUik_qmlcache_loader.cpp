...
namespace _qt_qml_KUik_qml_pages_Signup_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
namespace _qt_qml_KUik_qml_pages_Login_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
namespace _qt_qml_KUik_qml_pages_WatchHistory_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
Registry::Registry() {
    ...
    resourcePathToCachedUnit.insert(QStringLiteral("/qt/qml/KUik/qml/pages/Signup.qml"), &QmlCacheGeneratedCode::_qt_qml_KUik_qml_pages_Signup_qml::unit);
    resourcePathToCachedUnit.insert(QStringLiteral("/qt/qml/KUik/qml/pages/Login.qml"), &QmlCacheGeneratedCode::_qt_qml_KUik_qml_pages_Login_qml::unit);
    resourcePathToCachedUnit.insert(QStringLiteral("/qt/qml/KUik/qml/pages/WatchHistory.qml"), &QmlCacheGeneratedCode::_qt_qml_KUik_qml_pages_WatchHistory_qml::unit);
...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_KUik)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_KUik))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_KUik)() {
    return 1;
}
